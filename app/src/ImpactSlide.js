...
export function ImpactSlide(props) {
    return (
        <>
            ...
            <div id="impact-rec-desc" className="center-text">
                {props.rec}
            </div>
            <div id="impact-rec-impact" className="center-text">
                {props.impact}
            </div>
            <h4 id="set-goal-question" className="center-text">
                Set this goal?
            </h4>
